...
describe('[LocalStrategy]', () => {
    it('Validates user by username and password', async () => {
        ...
        validateUserMock.mockResolvedValue({username: 'test', password: 'pass'} as UserDto);
    ...
    it('Throws exception when user does not exist', async () => {
        ...
        try{
            ...
            expect(e.message).toEqual('The given password is incorrect or the user does not exist');
        }
    });
});